...
use \TagsQuery as ChildTagsQuery;
use \Exception;
use \PDO;
use Map\TagsTableMap;
...
abstract class Tags implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\TagsTableMap';
    ...
    /**
     * Initializes internal state of Base\Tags object.
     */
     ...
     * @return $this|\Tags The current object (for fluent API support)
     */
    ...
    public function setNome($v)
    {
        ...
        if ($this->nome !== $v) {
            $this->nome = $v;
            $this->modifiedColumns[TagsTableMap::COL_NOME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TagsTableMap::translateFieldName('Nome', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = TagsTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Tags'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TagsTableMap::COL_NOME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TagsTableMap::COL_NOME)) {
            $criteria->add(TagsTableMap::COL_NOME, $this->nome);
        }
