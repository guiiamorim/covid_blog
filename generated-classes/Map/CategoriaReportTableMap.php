...
class CategoriaReportTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.CategoriaReportTableMap';
     ...
     */
    const OM_CLASS = '\\CategoriaReport';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CategoriaReport';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\CategoriaReport');
        $this->setPackage('');
    ...
    {
        $this->addRelation('Report', '\\Report', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idCategoria',
    1 => ':id',
