...
abstract class Usuario implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = 'App\\Models\\Map\\UsuarioTableMap';
     ...
     *
     * Note: this column has a database default value of: 'usr'
     * @var        string
     */
    protected $tipo;
    ...
    /**
     * The value for the idcomunidade field.
     *
     * @var        int
     */
    ...
    /**
     * Get the [idcomunidade] column value.
     *
     * @return int
     */
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[UsuarioTableMap::COL_STATUS] = true;
        }
    ...
    public function setFoto($v)
    {
        ...
        if ($this->foto !== $v) {
            $this->foto = $v;
            $this->modifiedColumns[UsuarioTableMap::COL_FOTO] = true;
        }
    ...
    /**
     * Set the value of [idcomunidade] column.
     *
     * @param int $v new value
     * @return $this|\Usuario The current object (for fluent API support)
     */
    public function setIdcomunidade($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->idcomunidade !== $v) {
            $this->idcomunidade = $v;
            $this->modifiedColumns[UsuarioTableMap::COL_IDCOMUNIDADE] = true;
        }

        if ($this->aComunidade !== null && $this->aComunidade->getId() !== $v) {
            $this->aComunidade = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UsuarioTableMap::translateFieldName('Tipo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tipo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UsuarioTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : UsuarioTableMap::translateFieldName('Telefone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->telefone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : UsuarioTableMap::translateFieldName('Foto', TableMap::TYPE_PHPNAME, $indexType)];
            $this->foto = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : UsuarioTableMap::translateFieldName('Idcomunidade', TableMap::TYPE_PHPNAME, $indexType)];
            $this->idcomunidade = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            return $startcol + 9; // 9 = UsuarioTableMap::NUM_HYDRATE_COLUMNS.
    ...
    {
        if ($this->aComunidade !== null && $this->idcomunidade !== $this->aComunidade->getId()) {
            $this->aComunidade = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aComunidade !== null) {
                if ($this->aComunidade->isModified() || $this->aComunidade->isNew()) {
                    $affectedRows += $this->aComunidade->save($con);
                }
                $this->setComunidade($this->aComunidade);
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UsuarioTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(UsuarioTableMap::COL_TELEFONE)) {
            $modifiedColumns[':p' . $index++]  = 'telefone';
        }
        if ($this->isColumnModified(UsuarioTableMap::COL_FOTO)) {
            $modifiedColumns[':p' . $index++]  = 'foto';
        }
        if ($this->isColumnModified(UsuarioTableMap::COL_IDCOMUNIDADE)) {
            $modifiedColumns[':p' . $index++]  = 'idComunidade';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'foto':
                        ...
                        break;
                    case 'idComunidade':
                        $stmt->bindValue($identifier, $this->idcomunidade, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aComunidade) {
                ...
                $result[$key] = $this->aComunidade->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[6], $arr)) {
            $this->setTelefone($arr[$keys[6]]);
        }
        if (array_key_exists($keys[7], $arr)) {
            $this->setFoto($arr[$keys[7]]);
        }
        if (array_key_exists($keys[8], $arr)) {
            $this->setIdcomunidade($arr[$keys[8]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UsuarioTableMap::COL_STATUS)) {
            $criteria->add(UsuarioTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(UsuarioTableMap::COL_TELEFONE)) {
            $criteria->add(UsuarioTableMap::COL_TELEFONE, $this->telefone);
        }
        if ($this->isColumnModified(UsuarioTableMap::COL_FOTO)) {
            $criteria->add(UsuarioTableMap::COL_FOTO, $this->foto);
        }
        if ($this->isColumnModified(UsuarioTableMap::COL_IDCOMUNIDADE)) {
            $criteria->add(UsuarioTableMap::COL_IDCOMUNIDADE, $this->idcomunidade);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setIdcomunidade($this->getIdcomunidade());
        if ($makeNew) {
            $copyObj->setNew(true);
    ...
    /**
     * Declares an association between this object and a ChildComunidade object.
     *
     * @param  ChildComunidade $v
     * @return $this|\Usuario The current object (for fluent API support)
     * @throws PropelException
     */
    public function setComunidade(ChildComunidade $v = null)
    {
        if ($v === null) {
            $this->setIdcomunidade(NULL);
        } else {
            $this->setIdcomunidade($v->getId());
        }

        $this->aComunidade = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the ChildComunidade object, it will not be re-added.
        if ($v !== null) {
            $v->addUsuario($this);
        }
    ...
    /**
     * Get the associated ChildComunidade object
     *
     * @param  ConnectionInterface $con Optional Connection object.
     * @return ChildComunidade The associated ChildComunidade object.
     * @throws PropelException
     */
    public function getComunidade(ConnectionInterface $con = null)
    {
        if ($this->aComunidade === null && ($this->idcomunidade != 0)) {
            $this->aComunidade = ChildComunidadeQuery::create()->findPk($this->idcomunidade, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aComunidade->addUsuarios($this);
             */
        }

        return $this->aComunidade;
    }
    ...
    {
        if (null !== $this->aComunidade) {
            $this->aComunidade->removeUsuario($this);
        }
        $this->id = null;
        $this->nome = null;
        $this->email = null;
