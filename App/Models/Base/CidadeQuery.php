...
abstract class CidadeQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = 'App\\Models\\Cidade', $modelAlias = null)
    {
    ...
    {
        if ($comunidade instanceof App\Models\Comunidade) {
            return $this
    ...
    public function useComunidadeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'Comunidade', 'App\Models\ComunidadeQuery');
    }
