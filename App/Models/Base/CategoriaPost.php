...
use \Exception;
use \PDO;
use App\Models\Map\CategoriaPostTableMap;
...
/**
 * Base class that represents a row from the 'categoria_post' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class CategoriaPost implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = 'App\\Models\\Map\\CategoriaPostTableMap';
    ...
    /**
     * Initializes internal state of Base\CategoriaPost object.
     */
    ...
    /**
     * Compares this with another <code>CategoriaPost</code> instance.  If
     * <code>obj</code> is an instance of <code>CategoriaPost</code>, delegates to
     * <code>equals(CategoriaPost)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CategoriaPost The current object, for fluid interface
     */
     ...
     * @return $this|\CategoriaPost The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[CategoriaPostTableMap::COL_ID] = true;
        }
    ...
    public function setNome($v)
    {
        ...
        if ($this->nome !== $v) {
            $this->nome = $v;
            $this->modifiedColumns[CategoriaPostTableMap::COL_NOME] = true;
        }
    ...
    public function setDescricao($v)
    {
        ...
        if ($this->descricao !== $v) {
            $this->descricao = $v;
            $this->modifiedColumns[CategoriaPostTableMap::COL_DESCRICAO] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CategoriaPostTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CategoriaPostTableMap::translateFieldName('Nome', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nome = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CategoriaPostTableMap::translateFieldName('Descricao', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = CategoriaPostTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CategoriaPost'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCategoriaPostQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CategoriaPost::setDeleted()
     * @see CategoriaPost::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCategoriaPostQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CategoriaPostTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[CategoriaPostTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . CategoriaPostTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(CategoriaPostTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(CategoriaPostTableMap::COL_NOME)) {
            $modifiedColumns[':p' . $index++]  = 'nome';
        }
        if ($this->isColumnModified(CategoriaPostTableMap::COL_DESCRICAO)) {
            $modifiedColumns[':p' . $index++]  = 'descricao';
        }

        $sql = sprintf(
            'INSERT INTO categoria_post (%s) VALUES (%s)',
    ...
    {
        $pos = CategoriaPostTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['CategoriaPost'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CategoriaPost'][$this->hashCode()] = true;
        $keys = CategoriaPostTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getNome(),
    ...
    {
        $criteria = new Criteria(CategoriaPostTableMap::DATABASE_NAME);

        if ($this->isColumnModified(CategoriaPostTableMap::COL_ID)) {
            $criteria->add(CategoriaPostTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(CategoriaPostTableMap::COL_NOME)) {
            $criteria->add(CategoriaPostTableMap::COL_NOME, $this->nome);
        }
        if ($this->isColumnModified(CategoriaPostTableMap::COL_DESCRICAO)) {
            $criteria->add(CategoriaPostTableMap::COL_DESCRICAO, $this->descricao);
        }
    ...
    {
        $criteria = ChildCategoriaPostQuery::create();
        $criteria->add(CategoriaPostTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CategoriaPost (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CategoriaPost Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildCategoriaPost is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildCategoriaPost The current object (for fluent API support)
     */
    public function setPostCategorias(Collection $postCategorias, ConnectionInterface $con = null)
    {
        ...
        foreach ($postCategoriasToDelete as $postCategoriaRemoved) {
            $postCategoriaRemoved->setCategoriaPost(null);
        }
    ...
    protected function doAddPostCategoria(ChildPostCategoria $postCategoria)
    {
        ...
        $postCategoria->setCategoriaPost($this);
    }
    ...
    public function removePostCategoria(ChildPostCategoria $postCategoria)
    {
        if ($this->getPostCategorias()->contains($postCategoria)) {
            ...
            $postCategoria->setCategoriaPost(null);
        }
     ...
     * Otherwise if this CategoriaPost is new, it will return
     * an empty collection; or if this CategoriaPost has previously
     * been saved, it will retrieve related PostCategorias from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CategoriaPost.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildPostCategoria[] List of ChildPostCategoria objects
     */
    public function getPostCategoriasJoinPost(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildPostCategoriaQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(CategoriaPostTableMap::DEFAULT_STRING_FORMAT);
    }
