...
class ReportTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Models.Map.ReportTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Models\\Report';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Models.Report';
     ...
     */
    const COL_IDUSUARIO = 'report.idUsuario';

    /**
     * the column name for the comentario field
     */
    const COL_COMENTARIO = 'report.comentario';

    /**
     * the column name for the idCategoria field
     */
    const COL_IDCATEGORIA = 'report.idCategoria';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Idusuario', 'Comentario', 'Idcategoria', ),
        self::TYPE_CAMELNAME     => array('id', 'idusuario', 'comentario', 'idcategoria', ),
        self::TYPE_COLNAME       => array(ReportTableMap::COL_ID, ReportTableMap::COL_IDUSUARIO, ReportTableMap::COL_COMENTARIO, ReportTableMap::COL_IDCATEGORIA, ),
        self::TYPE_FIELDNAME     => array('id', 'idUsuario', 'comentario', 'idCategoria', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Idusuario' => 1, 'Comentario' => 2, 'Idcategoria' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'idusuario' => 1, 'comentario' => 2, 'idcategoria' => 3, ),
        self::TYPE_COLNAME       => array(ReportTableMap::COL_ID => 0, ReportTableMap::COL_IDUSUARIO => 1, ReportTableMap::COL_COMENTARIO => 2, ReportTableMap::COL_IDCATEGORIA => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'idUsuario' => 1, 'comentario' => 2, 'idCategoria' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Models\\Report');
        ...
        $this->addForeignKey('idCategoria', 'Idcategoria', 'INTEGER', 'categoria_report', 'id', true, null, null);
    } // initialize()
    ...
    {
        $this->addRelation('CategoriaReport', '\\App\\Models\\CategoriaReport', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':idCategoria',
    1 => ':id',
        ...
        $this->addRelation('PostReport', '\\App\\Models\\PostReport', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idReport',
    1 => ':id',
  ),
), null, null, 'PostReports', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ReportTableMap::COL_IDUSUARIO);
            $criteria->addSelectColumn(ReportTableMap::COL_COMENTARIO);
            $criteria->addSelectColumn(ReportTableMap::COL_IDCATEGORIA);
        } else {
