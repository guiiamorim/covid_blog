...
class PostTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Models.Map.PostTableMap';
     ...
     */
    const OM_CLASS = 'App\\Models\\Post';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('App\\Models\\Post');
        $this->setPackage('');
    ...
    {
        $this->addRelation('PostCategoria', 'App\\Models\\PostCategoria', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idPost',
    1 => ':id',
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('PostTagsRelatedByIdpost', 'App\\Models\\PostTags', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idPost',
    1 => ':id',
        ...
        $this->addRelation('PostTagsRelatedByIdtag', 'App\\Models\\PostTags', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idTag',
    1 => ':id',
