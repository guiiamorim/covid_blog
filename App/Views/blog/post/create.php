		...
		<div class="col-md-12 relative">
			<div class="w-full bg-white mx-auto p-3">
				<div class="row">
                    ...
                    <div class="col-md-12">
                        <form action="<?= PATH ?>/post/store" method="post" enctype="multipart/form-data"
                              id="postCreate">
                            <div class="form-row">
                                <div class="col-md-4">
                    ...
                    border-gray-700 w-full h-10 p-6" placeholder="" required value="<?=
										$Sessao::retornaFormulario('PostController', 'cadastro')['titulo'] ?? '' ?>">
                                    </div>
                                </div>
                    ...
                    border-gray-700 w-full h-10 p-6" placeholder="" data-choices="<?= PATH . '/tag/list' ?>"
                                                data-create="<?= PATH . '/tag/store' ?>" required
                                                multiple>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group text-gray-700">
                                        ...
                                        border border-gray-700 w-full h-10 p-6" placeholder="" required multiple>
                                            <option value=""></option>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        border-gray-700 w-full px-6 py-3 text-gray-700">Escolha a imagem</label>
