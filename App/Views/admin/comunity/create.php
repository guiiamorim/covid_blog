...
<div class="bg-white pb-4 px-4 rounded-sm w-full shadow-sm">
    <div class="flex justify-between w-full pt-6 ">
        <h3 class="ml-3">Cadastrar Comunidade</h3>
    </div>
    <div class="mt-6">
        <form action="<?= PATH ?>/comunity/store" method="post">
            <div class="form-row">
                <div class="col-md-4">
                    <div class="form-group">
                     ...
                     w-full h-10 p-6" placeholder="" required value="<?=
						$Sessao::retornaFormulario('ComunityController', 'cadastro')['nome'] ?? '' ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                     ...
                     w-full h-12 px-6 bg-transparent" required>
                            <option value=""></option>
							<?php $c = $Sessao::retornaFormulario('ComunityController', 'cadastro')['idCidade'] ??
                                '' ?>
